...
/**
 * Creates new image from machine
 *
 *
 * @param options
 * @param callback
...
CloudAPI.prototype.createImageFromMachine = function(options, callback) {
    ...
    if (options.machine && typeof (options.machine) !== 'string')
        throw new TypeError('options.machineId must ba a string');

    console.log('Creating image 4');
    // !TODO: Image version is also required (options.version)

    if(!callback || typeof (callback) !== 'function')
        throw new TypeError('callback (function) required');

    console.log('Creating image 5');
    ...
    console.log('Creating image 6', account, options);
